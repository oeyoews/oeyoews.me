            ...
            <li className="ml-6 group">
              ...
              >
                <span className="absolute flex items-center justify-center w-6 h-6 rounded-full -left-3 ring-8 ring-white bg-white">
                  ...
                  <TbCircleChevronsRight className="hidden group-hover:block scale-0 group-hover:scale-100 h-4 w-4 text-gray-400 duration-300 transition-all group-hover:stroke-indigo-500 group-hover:stroke-2 group-hover:animate-bounce" />
                </span>

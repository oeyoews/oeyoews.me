---
title: 常用的一些 tiddlywiki 插件
---

{/* <!-- 在我刚接触 tiddlywiki 的时候, 几乎就像当初刚接触到 vim/neovim 一样, 一直在不断寻找尝试新的插件. 但是最后发现自己经常使用的插件几乎都是自己根据自己的需求写的. --> */}
...
* <TwPlugin name="plum-blossom" />: 随机梅花生长动画
...
* <TwPlugin name="tiddlywiki-codemirror-6" author="BTC" />: 由于 tw5 一直没有很好的编辑体验, 在 tw 社区有人将 cm6 移植到 tw 后, 我将其迁移到了 Moderndev, 并且添加了 VIM 编辑模式支持, 并且得益于 esbuild 的打包优化, 插件大小减少了将近 500kb. cm6 内置了更多的功能, 比如 autolist, 字符统计, 自动补全.
